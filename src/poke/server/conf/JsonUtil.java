...
public class JsonUtil {
	...
	public static <T> T decode(String data, Class<T> theClass){
		...
		{
			System.out.println("JsonMappingException problem in JSON Util");
			ex.printStackTrace();
			return null;
		}
		catch (JsonParseException ex)
		{
			System.out.println("JsonParseException in JSON Util");
			ex.printStackTrace();
			return null;
		}catch (IOException ex) {
			System.out.println("IO Exception problem in JSON Util");
			ex.printStackTrace();
			return null;
		}
	}
