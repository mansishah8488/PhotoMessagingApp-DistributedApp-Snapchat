...
public class ServerConf {
    ...
    //Change for inter-cluster communication Mansi Shah
	private OtherClusterConf otherCluster;
...
//Inter cluster communication changes
	/*public void addOtherClusterNode(ClusterNodeDesc node) {
		if (otherCluster == null)
			otherCluster = new OtherClusterConf();

		otherCluster.add(node);
	}*/

	public OtherClusterConf getOtherCluster() {
		return otherCluster;
	}

	public void setOtherCluster(OtherClusterConf conf) {
		// TODO should be a deep copy
		this.otherCluster = conf;
	}
	...
	/**
	 * inter cluster node configuration
	 * 
	 * @author Mansi Shah
	 * 
	 */
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static final class OtherClusterConf {
		private TreeMap<Float, ClusterNodeDesc> otherCluster;

		public ClusterNodeDesc getNode(String name) {
			return otherCluster.get(name);
		}

		/*public void add(ClusterNodeDesc node) {
			if (node == null)
				return;
			else if (otherCluster == null)
				otherCluster = new TreeMap<Float, ClusterNodeDesc>();

			otherCluster.put((Float)(node.getClusterId()+"."+node.getNodeId()), node);
		}*/

		public TreeMap<Float, ClusterNodeDesc> getOtherClusterNodes() {
			return otherCluster;
		}

		public void setOtherClusterNodes(TreeMap<Float, ClusterNodeDesc> nearest) {
			this.otherCluster = nearest;
		}
	}
